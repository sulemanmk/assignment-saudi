...
import com.productmanager.security.CustomAccessDeniedHandler;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Order endpoints - All authenticated users can place orders
                        .requestMatchers("/api/orders/**").authenticated()

                        // User management - Admin only for user management
